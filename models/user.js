...
class User {
  ...
  static async create({ username, user_email, password, idAdmin, bin_id }) {
    ...
    let response = await db.query(
      'INSERT INTO users (user_name, user_email,password, bin_id) VALUES ($1, $2,$3,$4) RETURNING user_id;',
  ...
  //   const response = await db.query(
  //     'SELECT complaints.title FROM complaints,users WHERE users.user_id = complaints.user_id AND users.user_id = $1',
  //     [id]
  //   )
